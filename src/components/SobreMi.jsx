      ...
      <div className="col-start-4 col-end-8 m-5 mr-14 p-10 rounded-lg">
        <div className="flex flex-col">
          <div className="flex flex-row justify-between items-center">
            <h1 className="mb-8 text-4xl font-josefin selection:bg-green-400 selection:text-green-900 transition-colors hover:text-green-900">
              Sobre mí
            </h1>
            <div className="mb-8">
          ...
          <div>
            <p className="text-justify tracking-wide text-lg text-green-800 font-mukta">
              Nací y crecí en la ciudad de <a href="https://www.google.com/maps/place/Gualeguaych%C3%BA,+Entre+R%C3%ADos/data=!4m2!3m1!1s0x95baa828f3333543:0xa95f93d6a79497c1?sa=X&ved=2ahUKEwjk7MabysT5AhXGl5UCHU98DZ8Q8gF6BAh-EAE" target="_blank" rel="noopener noreferrer" className="underline after:content-['_↗'] ...">Gualeguaychú, Entre Ríos, Argentina</a>. Desde
              pequeño siempre fui una persona curiosa, dedicada y detallista a
